package fi.oulu.danielszabo.pepper_base.itee_promotion_offline.llm_service.service;
...
import fi.oulu.danielszabo.pepper_base.itee_promotion_offline.llm_service.gpt35turbo_conversation.Conversation;
import fi.oulu.danielszabo.pepper_base.itee_promotion_offline.llm_service.gpt35turbo_conversation.LLMResponseWithOptions;
...
public class GPT35TurboPepperService {
  ...
  private static final double FREQUENCY_PENALTY = 0.4;
  private static final double PRESENCE_PENALTY = 0.2;
