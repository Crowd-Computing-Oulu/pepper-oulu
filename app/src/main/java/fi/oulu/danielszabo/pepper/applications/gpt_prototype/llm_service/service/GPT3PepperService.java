...
import fi.oulu.danielszabo.pepper.applications.gpt_prototype.llm_service.gpt3_conversation.Conversation;
import fi.oulu.danielszabo.pepper.applications.gpt_prototype.llm_service.gpt3_conversation.LLMResponseWithOptions;
import fi.oulu.danielszabo.pepper.applications.gpt_prototype.llm_service.prompts.PromptTemplateManager;
...
public class GPT3PepperService {
  ...
  private static final String ROBOT_NAME = "Pepper";
  private static final String USER_NAME = "Human";
